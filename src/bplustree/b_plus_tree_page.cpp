...
auto BPlusTreePage::IsLeafPage() const -> bool { return page_type_ == IndexPageType::LEAF_PAGE ? true : false; }
...
auto BPlusTreePage::IsSafe(OperationType op_type) const -> bool {
  ...
  return page_type_ == IndexPageType::INTERNAL_PAGE ? GetSize() > GetMinSize() + 1 : GetSize() > GetMinSize();
}
